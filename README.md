...
The website code and styles, including the complete page source and included page files, are dedicated to the public under the Zero-Clause BSD License (0BSD). You may copy, modify, publish, and use them for any purpose without asking permission or providing attribution. See [`LICENSE`](./LICENSE) for the full license text.
